...
abstract class AppColor {
  ...
  static const Color primaryLight = Color(0xFF845CC9);
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color secondaryLight = Color(0xFFE0E2E4);
  static const Color secondaryLight2 = Color(0xFFE0E2E4);
  static const Color onSecondaryLight = Color(0xFF845CC9);
  static const Color borderLightOnFocus = Color(0xFF845CC9);
  ...
  static const Color gray60014 = Color(0X147C7C7C);
